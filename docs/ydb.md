...
| `role_assignments` | Роли пользователей: `admin`, `organizer`, дата назначения и пользователь, который назначил роль. |
...
Администратор может добавлять и удалять Организаторов через меню администратора. Организаторов из `ORGANIZER_USER_IDS` меню показывает как заданных системой и не удаляет: их нужно убирать из конфигурации.
